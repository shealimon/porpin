...
export function AuthLightPageSurface({ children }: { children: ReactNode }) {
  return (
    <div className="relative flex min-h-0 flex-1 flex-col overflow-x-hidden bg-[#f6f4f1] font-sans text-[0.9375rem] text-stone-600 antialiased tab:text-base desk:flex-none desk:min-h-min desk:w-full">
      <div
